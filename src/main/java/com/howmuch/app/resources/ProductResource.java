...
import com.howmuch.app.services.ProductService;
...
public class ProductResource {
	...
	@GetMapping(value = "/{codbar}")
	public ResponseEntity<ProductDTO> findByCodBar(@PathVariable Long codBar) {
		ProductDTO obj = service.findByCodBar(codBar);
		return ResponseEntity.ok().body(obj);
	}
